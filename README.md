...
> **No PhD. No papers. Just building and thinking.**
> Tech Systems, AI, real-world engineering.
> *Results first. No hype required.*
>
> — *"Don't do anything a computer can do better."*

<!-- NOW:START -->
> 📚 **Now:** Last commits landed 11 days ago on python-sdk and docs—work on extraction strategy naming and summarization features. Quiet stretch now; likely reviewing patterns and thinking through next moves.
>
> *Updated: 2026-08-23*
<!-- NOW:END -->
...
### [ModelContextStandard](https://github.com/modelcontextstandard)
...
### [open-conversation-format](https://github.com/open-conversation-format)
...
### [LinkAuth](https://github.com/LinkAuth)
...
### [octaro-ai / cephix](https://github.com/octaro-ai/cephix)
...
>> [bizrockman/Unpublished-Papers](https://github.com/bizrockman/Unpublished-Papers) · EN/DE
...
- [**AutoTrader**](https://github.com/bizrockman/AutoTrader) - Draft, occasional tinkering
- [**DSPyTutorial**](https://github.com/bizrockman/DSPyTutorial) - Companion code for the DSPy article series


---

<sub>📍 d.gerst@bizrock.de · Status badge and Now block are refreshed daily from recent commits. Source: [`scripts/update_status.py`](scripts/update_status.py).</sub>
